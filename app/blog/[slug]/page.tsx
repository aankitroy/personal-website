...
// Generate static params for blog posts that don't have individual files
export async function generateStaticParams() {
  // Only include posts that don't have dedicated page files
  const blogSlugs: string[] = [
    // All posts now have individual files, so return empty array
  ];
